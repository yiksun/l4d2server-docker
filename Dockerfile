...
RUN wget https://steamcdn-a.akamaihd.net/client/installer/steamcmd_linux.tar.gz && \
    ...
    ./steamcmd.sh +force_install_dir /home/steam/l4d2server +login <username_here> <password_here> +@sSteamCmdForcePlatformType windows +app_update 222860 validate +quit && \
    ./steamcmd.sh +force_install_dir /home/steam/l4d2server +login <username_here> <password_here> +@sSteamCmdForcePlatformType linux +app_update 222860 validate +quit
